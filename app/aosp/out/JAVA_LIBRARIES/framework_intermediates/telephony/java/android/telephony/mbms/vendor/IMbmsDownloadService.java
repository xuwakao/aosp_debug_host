 ...
 * Original file: frameworks/base/telephony/java/android/telephony/mbms/vendor/IMbmsDownloadService.aidl
 */
...
case TRANSACTION_registerStateCallback:
{
data.enforceInterface(DESCRIPTOR);
android.telephony.mbms.DownloadRequest _arg0;
if ((0!=data.readInt())) {
...
android.telephony.mbms.IDownloadStateCallback _arg1;
_arg1 = android.telephony.mbms.IDownloadStateCallback.Stub.asInterface(data.readStrongBinder());
int _arg2;
_arg2 = data.readInt();
int _result = this.registerStateCallback(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_unregisterStateCallback:
{
data.enforceInterface(DESCRIPTOR);
android.telephony.mbms.DownloadRequest _arg0;
if ((0!=data.readInt())) {
...
android.telephony.mbms.IDownloadStateCallback _arg1;
_arg1 = android.telephony.mbms.IDownloadStateCallback.Stub.asInterface(data.readStrongBinder());
int _result = this.unregisterStateCallback(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
case TRANSACTION_getDownloadStatus:
{
data.enforceInterface(DESCRIPTOR);
android.telephony.mbms.DownloadRequest _arg0;
if ((0!=data.readInt())) {
...
int _result = this.getDownloadStatus(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
mRemote.transact(Stub.TRANSACTION_requestUpdateFileServices, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
mRemote.transact(Stub.TRANSACTION_setTempFileRootDirectory, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public int registerStateCallback(android.telephony.mbms.DownloadRequest downloadRequest, android.telephony.mbms.IDownloadStateCallback listener, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_registerStateCallback, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public int unregisterStateCallback(android.telephony.mbms.DownloadRequest downloadRequest, android.telephony.mbms.IDownloadStateCallback listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeStrongBinder((((listener!=null))?(listener.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_unregisterStateCallback, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
mRemote.transact(Stub.TRANSACTION_listPendingDownloads, _data, _reply, 0);
_reply.readException();
...
@Override public int getDownloadStatus(android.telephony.mbms.DownloadRequest downloadRequest, android.telephony.mbms.FileInfo fileInfo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_getDownloadStatus, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
mRemote.transact(Stub.TRANSACTION_resetDownloadKnowledge, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_registerStateCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_unregisterStateCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_listPendingDownloads = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_cancelDownload = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getDownloadStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_resetDownloadKnowledge = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_dispose = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
...
public int registerStateCallback(android.telephony.mbms.DownloadRequest downloadRequest, android.telephony.mbms.IDownloadStateCallback listener, int flags) throws android.os.RemoteException;
public int unregisterStateCallback(android.telephony.mbms.DownloadRequest downloadRequest, android.telephony.mbms.IDownloadStateCallback listener) throws android.os.RemoteException;
...
public int getDownloadStatus(android.telephony.mbms.DownloadRequest downloadRequest, android.telephony.mbms.FileInfo fileInfo) throws android.os.RemoteException;
