...
mRemote.transact(Stub.TRANSACTION_notifySimActivationStateChangedForPhoneId, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_notifySimActivationStateChangedForPhoneId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_notifyOemHookRawEventForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_notifySubscriptionInfoChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_notifyCarrierNetworkChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
}
