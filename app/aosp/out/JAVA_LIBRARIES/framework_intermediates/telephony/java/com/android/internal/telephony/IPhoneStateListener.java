...
mRemote.transact(Stub.TRANSACTION_onVoiceActivationStateChanged, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(activationState);
mRemote.transact(Stub.TRANSACTION_onDataActivationStateChanged, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onVoiceActivationStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_onDataActivationStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_onOemHookRawEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_onCarrierNetworkChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
}
