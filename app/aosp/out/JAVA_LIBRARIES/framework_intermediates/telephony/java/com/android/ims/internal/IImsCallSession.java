...
{
data.enforceInterface(DESCRIPTOR);
com.android.ims.ImsCallProfile _arg0;
if ((0!=data.readInt())) {
_arg0 = com.android.ims.ImsCallProfile.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
/**
     ...
     */
@Override public void sendRttModifyRequest(com.android.ims.ImsCallProfile toProfile) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_sendRttModifyRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_sendRttModifyResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_sendRttMessage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
}
/**
     * Closes the object. This object is not usable after being closed.
     */
...
/**
     ...
     * @param toProfile The profile with requested changes made
     */
public void sendRttModifyRequest(com.android.ims.ImsCallProfile toProfile) throws android.os.RemoteException;
/*
     * Device responds to Remote RTT modify request
     * @param status true : Accepted the request
     *                false : Declined the request
