 ...
 * Original file: frameworks/base/lowpan/java/android/net/lowpan/ILowpanInterface.aidl
 */
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getNcpVersion, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getSupportedChannels, _data, _reply, 0);
_reply.readException();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getSupportedNetworkTypes, _data, _reply, 0);
_reply.readException();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isUp, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isCommissioned, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getRole, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getPartitionId, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getExtendedAddress, _data, _reply, 0);
_reply.readException();
_result = _reply.createByteArray();
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLowpanIdentity, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLowpanCredential, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLinkAddresses, _data, _reply, 0);
_reply.readException();
_result = _reply.createStringArray();
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLinkNetworks, _data, _reply, 0);
_reply.readException();
...
mRemote.transact(Stub.TRANSACTION_form, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_startCommissioningSession, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_closeCommissioningSession, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_sendToCommissioner, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_beginLowPower, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_pollForData, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_onHostWake, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeStrongBinder((((listener!=null))?(listener.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_startNetScan, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_stopNetScan, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeMap(properties);
_data.writeStrongBinder((((listener!=null))?(listener.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_startEnergyScan, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_stopEnergyScan, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_addOnMeshPrefix, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_removeOnMeshPrefix, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInt(flags);
mRemote.transact(Stub.TRANSACTION_addExternalRoute, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_removeExternalRoute, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
