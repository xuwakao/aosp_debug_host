...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getDiscoveryEndMillis, _data, _reply, 0);
_reply.readException();
...
mRemote.transact(Stub.TRANSACTION_isBondingInitiatedLocally, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getSupportedProfiles, _data, _reply, 0);
_reply.readException();
_result = _reply.readLong();
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isLe2MPhySupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isLeCodedPhySupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isLeExtendedAdvertisingSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isLePeriodicAdvertisingSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLeMaximumAdvertisingDataLength, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_getDiscoveryEndMillis = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
...
static final int TRANSACTION_getBondedDevices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
...
static final int TRANSACTION_isBondingInitiatedLocally = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getSupportedProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getRemoteName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getRemoteType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getRemoteAlias = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_setRemoteAlias = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getRemoteClass = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getRemoteUuids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_fetchRemoteUuids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_sdpSearch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getBatteryLevel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_setPin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_setPasskey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_setPairingConfirmation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getPhonebookAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_setPhonebookAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_getMessageAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_setMessageAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_getSimAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_setSimAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_sendConnectionStateChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_registerCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_unregisterCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_connectSocket = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_createSocketChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_isMultiAdvertisementSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_isOffloadedFilteringSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_isOffloadedScanBatchingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_isActivityAndEnergyReportingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_isLe2MPhySupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_isLeCodedPhySupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_isLeExtendedAdvertisingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_isLePeriodicAdvertisingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_getLeMaximumAdvertisingDataLength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_reportActivityInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_requestActivityInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_onLeServiceUp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_onBrEdrDown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
}
