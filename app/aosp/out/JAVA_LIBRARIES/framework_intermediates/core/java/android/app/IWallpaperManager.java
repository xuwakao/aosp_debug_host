...
int _arg1;
_arg1 = data.readInt();
android.app.WallpaperColors _result = this.getWallpaperColors(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
int _arg1;
_arg1 = data.readInt();
this.registerWallpaperColorsCallback(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
int _arg1;
_arg1 = data.readInt();
this.unregisterWallpaperColorsCallback(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
/**
     ...
     */
@Override public android.app.WallpaperColors getWallpaperColors(int which, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
_data.writeInt(which);
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_getWallpaperColors, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
/**
     ...
     */
@Override public void registerWallpaperColorsCallback(android.app.IWallpaperManagerCallback cb, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeStrongBinder((((cb!=null))?(cb.asBinder()):(null)));
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_registerWallpaperColorsCallback, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     */
@Override public void unregisterWallpaperColorsCallback(android.app.IWallpaperManagerCallback cb, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeStrongBinder((((cb!=null))?(cb.asBinder()):(null)));
_data.writeInt(userId);
mRemote.transact(Stub.TRANSACTION_unregisterWallpaperColorsCallback, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
     ...
     * @return colors of chosen wallpaper
     */
public android.app.WallpaperColors getWallpaperColors(int which, int userId) throws android.os.RemoteException;
/**
     * Register a callback to receive color updates
     */
public void registerWallpaperColorsCallback(android.app.IWallpaperManagerCallback cb, int userId) throws android.os.RemoteException;
/**
     * Unregister a callback that was receiving color updates
     */
public void unregisterWallpaperColorsCallback(android.app.IWallpaperManagerCallback cb, int userId) throws android.os.RemoteException;
}
