 ...
 * Original file: frameworks/base/core/java/android/content/pm/IDexModuleRegisterCallback.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_onDexModuleRegistered, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
