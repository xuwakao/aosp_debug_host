 ...
 * Original file: frameworks/base/core/java/android/bluetooth/IBluetoothMapClient.aidl
 */
...
/**
 * Cast an IBinder object into an android.bluetooth.IBluetoothMapClient interface,
 * generating a proxy if needed.
 */
public static android.bluetooth.IBluetoothMapClient asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
...
@Override public boolean sendMessage(android.bluetooth.BluetoothDevice device, android.net.Uri[] contacts, java.lang.String message, android.app.PendingIntent sentIntent, android.app.PendingIntent deliveryIntent) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean getUnreadMessages(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
static final int TRANSACTION_getConnectedDevices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getDevicesMatchingConnectionStates = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_getConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_setPriority = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getPriority = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_sendMessage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getUnreadMessages = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
}
...
public boolean sendMessage(android.bluetooth.BluetoothDevice device, android.net.Uri[] contacts, java.lang.String message, android.app.PendingIntent sentIntent, android.app.PendingIntent deliveryIntent) throws android.os.RemoteException;
public boolean getUnreadMessages(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException;
}
