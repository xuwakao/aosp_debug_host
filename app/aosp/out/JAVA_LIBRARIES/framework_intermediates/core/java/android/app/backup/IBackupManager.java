...
case TRANSACTION_initializeTransports:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String[] _arg0;
...
/**
     ...
     */
@Override public void initializeTransports(java.lang.String[] transportNames, android.app.backup.IBackupObserver observer) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_initializeTransports, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_initializeTransports = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_agentConnected = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_agentDisconnected = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_restoreAtInstall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_setBackupEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setAutoRestore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setBackupProvisioned = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_isBackupEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setBackupPassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_hasBackupPassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_backupNow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_adbBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_fullTransportBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_adbRestore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_acknowledgeFullBackupOrRestore = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getCurrentTransport = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_listAllTransports = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_listAllTransportComponents = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getTransportWhitelist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_selectBackupTransport = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_selectBackupTransportAsync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getConfigurationIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getDestinationString = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getDataManagementIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getDataManagementLabel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_beginRestoreSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_opComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setBackupServiceActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_isBackupServiceActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getAvailableRestoreToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_isAppEligibleForBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_requestBackup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_cancelBackups = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
}
/**
     * Tell the system service that the caller has made changes to its
     * data, and therefore needs to undergo an incremental backup pass.
