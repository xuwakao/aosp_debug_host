...
if ((0!=data.readInt())) {
_arg0 = android.security.keymaster.KeymasterArguments.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
android.security.keymaster.KeymasterCertificateChain _arg1;
_arg1 = new android.security.keymaster.KeymasterCertificateChain();
...
@Override public int attestDeviceIds(android.security.keymaster.KeymasterArguments params, android.security.keymaster.KeymasterCertificateChain chain) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_attestDeviceIds = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_onDeviceOffBody = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
}
...
public int attestDeviceIds(android.security.keymaster.KeymasterArguments params, android.security.keymaster.KeymasterCertificateChain chain) throws android.os.RemoteException;
