...
static final int TRANSACTION_getPlayerSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_setPlayerApplicationSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_sendGroupNavigationCmd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
