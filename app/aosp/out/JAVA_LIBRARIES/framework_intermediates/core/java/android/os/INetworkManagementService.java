...
static final int TRANSACTION_setInterfaceIpv6NdOffload = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_addRoute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_removeRoute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
...
static final int TRANSACTION_startInterfaceForwarding = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_stopInterfaceForwarding = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_enableNat = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_disableNat = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_registerTetheringStatsProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_unregisterTetheringStatsProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_tetherLimitReached = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_listTtys = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_attachPppd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_detachPppd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
...
static final int TRANSACTION_setFirewallEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_isFirewallEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_setFirewallInterfaceRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_setFirewallUidRule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_setFirewallUidRules = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_setFirewallChainEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_addVpnUidRanges = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_removeVpnUidRanges = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_startClatd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_stopClatd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_isClatdStarted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_registerNetworkActivityListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_unregisterNetworkActivityListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_isNetworkActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_createPhysicalNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_createVirtualNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_removeNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_addInterfaceToNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
static final int TRANSACTION_removeInterfaceFromNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
static final int TRANSACTION_addLegacyRouteForNetId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
static final int TRANSACTION_setDefaultNetId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 76);
static final int TRANSACTION_clearDefaultNetId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
static final int TRANSACTION_setNetworkPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
static final int TRANSACTION_setPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
static final int TRANSACTION_clearPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
static final int TRANSACTION_allowProtect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
static final int TRANSACTION_denyProtect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
static final int TRANSACTION_addInterfaceToLocalNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
static final int TRANSACTION_removeInterfaceFromLocalNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
static final int TRANSACTION_removeRoutesFromLocalNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
static final int TRANSACTION_setAllowOnlyVpnForUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
static final int TRANSACTION_isNetworkRestricted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 87);
}
/**
     ** GENERAL
     **//**
