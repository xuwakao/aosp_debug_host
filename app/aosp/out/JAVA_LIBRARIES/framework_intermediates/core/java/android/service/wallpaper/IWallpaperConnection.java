...
this.onWallpaperColorsChanged(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public void onWallpaperColorsChanged(android.app.WallpaperColors colors) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_onWallpaperColorsChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void onWallpaperColorsChanged(android.app.WallpaperColors colors) throws android.os.RemoteException;
}
