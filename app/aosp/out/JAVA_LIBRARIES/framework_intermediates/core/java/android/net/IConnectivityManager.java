...
_data.writeInt(userId);
_data.writeString(packageName);
mRemote.transact(Stub.TRANSACTION_isAlwaysOnVpnPackageSupported, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_isAlwaysOnVpnPackageSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_setAlwaysOnVpnPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_getAlwaysOnVpnPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_checkMobileProvisioning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_getMobileProvisioningUrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_setProvisioningNotificationVisible = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_setAirplaneMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_registerNetworkFactory = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_requestBandwidthUpdate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
...
static final int TRANSACTION_releasePendingNetworkRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_listenForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_pendingListenForNetwork = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_releaseNetworkRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_setAcceptUnvalidated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_setAvoidUnvalidated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_startCaptivePortalApp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_getMultipathPreference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_getRestoreDefaultNetworkDelay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_addVpnAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_removeVpnAddress = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_setUnderlyingNetworksForVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_startNattKeepalive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_stopKeepalive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
static final int TRANSACTION_getCaptivePortalServerUrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
}
