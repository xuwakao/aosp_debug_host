...
android.util.MergedConfiguration _arg14;
_arg14 = new android.util.MergedConfiguration();
...
static final int TRANSACTION_prepareToReplaceWindows = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
...
static final int TRANSACTION_cancelDragAndDrop = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_dragRecipientEntered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_dragRecipientExited = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_setWallpaperPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_wallpaperOffsetsComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setWallpaperDisplayOffset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_sendWallpaperCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_wallpaperCommandComplete = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
...
static final int TRANSACTION_pokeDrawLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_startMovingTask = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_updatePointerIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
}
