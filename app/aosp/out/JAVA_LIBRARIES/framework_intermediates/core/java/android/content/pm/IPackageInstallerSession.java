...
static final int TRANSACTION_transfer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_abandon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
}
