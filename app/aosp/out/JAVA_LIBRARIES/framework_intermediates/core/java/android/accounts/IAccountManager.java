...
static final int TRANSACTION_addSharedAccountsFromParentUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_renameAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getPreviousName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_renameSharedAccountAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_startAddAccountSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_startUpdateCredentialsSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_finishSessionAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_someUserHasAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_isCredentialsUpdateSuggested = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getPackagesAndVisibilityForAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_addAccountExplicitlyWithVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_setAccountVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_getAccountVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_getAccountsAndVisibilityForPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_registerAccountListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_unregisterAccountListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_hasAccountAccess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_createRequestAccountAccessIntentSenderAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_onAccountAccessed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
}
