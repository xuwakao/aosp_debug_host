...
case TRANSACTION_createInputForwarder:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
android.app.IInputForwarder _result = this.createInputForwarder(_arg0);
reply.writeNoException();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(deviceId);
mRemote.transact(Stub.TRANSACTION_isInputDeviceEnabled, _data, _reply, 0);
_reply.readException();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(deviceId);
mRemote.transact(Stub.TRANSACTION_disableInputDevice, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public android.app.IInputForwarder createInputForwarder(int displayId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.app.IInputForwarder _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(displayId);
mRemote.transact(Stub.TRANSACTION_createInputForwarder, _data, _reply, 0);
_reply.readException();
_result = android.app.IInputForwarder.Stub.asInterface(_reply.readStrongBinder());
}
finally {
_reply.recycle();
_data.recycle();
...
static final int TRANSACTION_getKeyboardLayoutForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setKeyboardLayoutForInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_registerInputDevicesChangedListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_isInTabletMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_registerTabletModeChangedListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_vibrate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_cancelVibrate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_setPointerIconType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setCustomPointerIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_requestPointerCapture = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_createInputForwarder = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
}
// Gets input device information.
...
/** Create input forwarder to deliver touch events to owned display. */
public android.app.IInputForwarder createInputForwarder(int displayId) throws android.os.RemoteException;
}
