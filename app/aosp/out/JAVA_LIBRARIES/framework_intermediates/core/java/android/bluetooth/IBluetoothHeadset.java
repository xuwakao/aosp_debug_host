...
case TRANSACTION_setForceScoAudio:
{
data.enforceInterface(DESCRIPTOR);
boolean _arg0;
_arg0 = (0!=data.readInt());
...
@Override public void setForceScoAudio(boolean forced) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setForceScoAudio, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInt(type);
mRemote.transact(Stub.TRANSACTION_phoneStateChanged, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_setForceScoAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
...
static final int TRANSACTION_enableWBS = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_disableWBS = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_bindResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
}
// Public API
...
public void setForceScoAudio(boolean forced) throws android.os.RemoteException;
