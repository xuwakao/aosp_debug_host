...
@Override public boolean terminateCall(android.bluetooth.BluetoothDevice device, android.bluetooth.BluetoothHeadsetClientCall call) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public android.bluetooth.BluetoothHeadsetClientCall dial(android.bluetooth.BluetoothDevice device, java.lang.String number) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public boolean connectAudio(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean disconnectAudio(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public void setAudioRouteAllowed(android.bluetooth.BluetoothDevice device, boolean allowed) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public boolean getAudioRouteAllowed(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
static final int TRANSACTION_getCurrentCalls = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getCurrentAgEvents = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_acceptCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_holdCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_rejectCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_terminateCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_enterPrivateMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_explicitCallTransfer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_dial = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_sendDTMF = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getLastVoiceTagNumber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getAudioState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_connectAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_disconnectAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setAudioRouteAllowed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getAudioRouteAllowed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getCurrentAgFeatures = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
}
...
public boolean terminateCall(android.bluetooth.BluetoothDevice device, android.bluetooth.BluetoothHeadsetClientCall call) throws android.os.RemoteException;
...
public android.bluetooth.BluetoothHeadsetClientCall dial(android.bluetooth.BluetoothDevice device, java.lang.String number) throws android.os.RemoteException;
...
public boolean connectAudio(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException;
public boolean disconnectAudio(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException;
public void setAudioRouteAllowed(android.bluetooth.BluetoothDevice device, boolean allowed) throws android.os.RemoteException;
public boolean getAudioRouteAllowed(android.bluetooth.BluetoothDevice device) throws android.os.RemoteException;
