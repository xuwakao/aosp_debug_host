...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getStableDisplaySize, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
static final int TRANSACTION_getStableDisplaySize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
}
