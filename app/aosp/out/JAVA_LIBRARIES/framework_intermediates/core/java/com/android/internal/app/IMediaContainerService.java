...
static final int TRANSACTION_clearDirectory = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_calculateInstalledSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
