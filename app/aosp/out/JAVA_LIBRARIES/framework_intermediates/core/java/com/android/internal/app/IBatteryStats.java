...
@Override public void noteJobFinish(java.lang.String name, int uid, int stopReason) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_takeUidSnapshot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
static final int TRANSACTION_takeUidSnapshots = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
static final int TRANSACTION_noteBluetoothControllerActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
static final int TRANSACTION_noteModemControllerActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
static final int TRANSACTION_noteWifiControllerActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
}
// These first methods are also called by native code, so must
// be kept in sync with frameworks/native/include/binder/IBatteryStats.h
...
public void noteJobFinish(java.lang.String name, int uid, int stopReason) throws android.os.RemoteException;
