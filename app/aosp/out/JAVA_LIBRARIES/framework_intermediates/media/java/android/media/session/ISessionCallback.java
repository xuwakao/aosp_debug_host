...
@Override public void onPrepare() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void onPrepareFromMediaId(java.lang.String mediaId, android.os.Bundle extras) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void onPrepareFromSearch(java.lang.String query, android.os.Bundle extras) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public void onPrepareFromUri(android.net.Uri uri, android.os.Bundle extras) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
static final int TRANSACTION_onPrepare = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_onPrepareFromMediaId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_onPrepareFromSearch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_onPrepareFromUri = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_onPlay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_onPlayFromMediaId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_onPlayFromSearch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_onPlayFromUri = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_onSkipToTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_onPause = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_onStop = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_onNext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_onPrevious = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_onFastForward = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_onRewind = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_onSeekTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_onRate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_onCustomAction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_onAdjustVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_onSetVolumeTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
}
...
public void onPrepareFromMediaId(java.lang.String mediaId, android.os.Bundle extras) throws android.os.RemoteException;
public void onPrepareFromSearch(java.lang.String query, android.os.Bundle extras) throws android.os.RemoteException;
public void onPrepareFromUri(android.net.Uri uri, android.os.Bundle extras) throws android.os.RemoteException;
