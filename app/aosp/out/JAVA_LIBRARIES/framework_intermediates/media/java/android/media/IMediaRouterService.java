...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((client!=null))?(client.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_isPlaybackActive, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_isPlaybackActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_setDiscoveryRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_setSelectedRoute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_requestSetVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_requestUpdateVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
}
