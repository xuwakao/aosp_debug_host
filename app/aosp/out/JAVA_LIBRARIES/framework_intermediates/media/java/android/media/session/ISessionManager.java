...
this.dispatchVolumeKeyEvent(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
@Override public void dispatchVolumeKeyEvent(android.view.KeyEvent keyEvent, int stream, boolean musicOnly) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_dispatchVolumeKeyEvent, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((listener!=null))?(listener.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_setOnVolumeKeyLongPressListener, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((listener!=null))?(listener.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_setOnMediaKeyListener, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_dispatchVolumeKeyEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_dispatchAdjustVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_addSessionsListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_removeSessionsListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setRemoteVolumeController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_isGlobalPriorityActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setOnVolumeKeyLongPressListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_setOnMediaKeyListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
}
...
public void dispatchVolumeKeyEvent(android.view.KeyEvent keyEvent, int stream, boolean musicOnly) throws android.os.RemoteException;
