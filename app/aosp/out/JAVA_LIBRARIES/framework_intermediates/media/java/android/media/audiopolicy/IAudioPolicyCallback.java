...
_data.writeInt(requestResult);
mRemote.transact(Stub.TRANSACTION_notifyAudioFocusRequest, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_notifyAudioFocusAbandon, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
