 ...
 * Original file: frameworks/base/media/java/android/media/session/IOnVolumeKeyLongPressListener.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_onVolumeKeyLongPress, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
