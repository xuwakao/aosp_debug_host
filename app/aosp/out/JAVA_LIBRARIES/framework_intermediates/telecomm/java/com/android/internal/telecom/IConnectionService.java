...
mRemote.transact(Stub.TRANSACTION_createConnectionComplete, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_createConnectionFailed, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_startRtt, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_respondToRttUpgradeRequest, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_reject = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_rejectWithMessage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_disconnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_silence = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_hold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_unhold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_onCallAudioStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_playDtmfTone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_stopDtmfTone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_conference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_splitFromConference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_mergeConference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_swapConference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_onPostDialContinue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_pullExternalCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_sendCallEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_onExtrasChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_startRtt = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_stopRtt = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_respondToRttUpgradeRequest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
}
